...
<section id="main-content">
	<section class="wrapper">
		<!-- page start-->
		<form id="update_event_form" class="form-horizontal" action="${BASE_PATH}/manage/event/update.json"  autocomplete="off"  method="post"
              >
			<fieldset>
		<div class="row">
						...
						<div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" style="font-size:15px;width: 300px;" class="form-control" name="name"
                              	placeholder="活动名称" id="name" value="${event.name}">
                              </input>
                          </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" data-link-format="yyyy-MM-dd" data-date-format="yyyy-MM-dd" style="font-size:15px;width: 200px;" class="js_create_time" name="createTime"
                                       placeholder="发布时间" id="createTime" value="${event.createTime?string("yyyy-MM-dd")}">
                                </input>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="margin-bottom:10px;">
                                <input name="important" value="1" type="radio" <#if event.important == 1>checked</#if>> 是
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <script id="content" name="content" type="text/plain"
                                        style="width: 100%; height: 260px;">${event.content!}</script>
	...
	$('#update_event_form').ajaxForm({
			...
			success : function(data) {
				if (data.result) {
					...
					showErrors($('#update_event_form'),data.errors);
				}
			}
		});
