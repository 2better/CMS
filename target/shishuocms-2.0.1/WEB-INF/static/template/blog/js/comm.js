...
$(document).ready(function(e) {
	var url1 = $('#area1-url').html();
	$('.area1 .title-con-l').click(function(event) {
		 window.location.href=url1; 
	});
	var url2 = $('#area2-url').html();
	$('.area2 .title-con-l').click(function(event) {
		 window.location.href=url2; 
	});
	var imgUrl1 = $('#area1-img').html()
	var imgUrl2 = $('#area2-img').html()
	$('.area1 .title-con-r img').attr({'src':imgUrl1})
	$('.area2 .area2-top img').attr({'src':imgUrl2})
	$('.area4 .area-con ul li').last().css({'border-bottom':0})
	$('.area5 .area-con ul li').last().css({'border-bottom':0})
	var imgw=$(".right-main-show div img").width();
	var conw=$(".right-main-show").width();
	if(imgw>conw){
		$('.right-main-show div img').css('width',"100%");
	}
	$("#leftr").click(function(){gd.Direction=2;});
	$("#rightr").click(function(){gd.Direction=3;});
	if ($('.media').size()>0){
		$('.media').media({
		 width:w,
		 height:h,
