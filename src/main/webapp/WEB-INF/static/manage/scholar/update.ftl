...
<section id="main-content">
	<section class="wrapper">
		<!-- page start-->
		<form id="update_scholar_form" class="form-horizontal" action="${BASE_PATH}/manage/scholar/update.json"  autocomplete="off"  method="post"
						...
						<div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" style="font-size:15px;width: 300px;" class="form-control" name="name"
                              	placeholder="学者名称" id="name" value="${scholar.name}">
                              </input>
                          </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" data-link-format="yyyy-MM-dd" data-date-format="yyyy-MM-dd" style="font-size:15px;width: 200px;" class="js_create_time" name="createTime"
                                       placeholder="发布时间" id="createTime" value="${scholar.createTime?string("yyyy-MM-dd")}">
                                </input>
                            </div>
                        </div>
                        <input type="hidden" name="picUrl" value="${scholar.picUrl!}">
                        <div class="form-group panel panel-default" >
                            <label class="col-sm-2 control-label">
                                学者头像
                            </label>
                            <div class="col-sm-10">
                                <a href="#demo" data-toggle="collapse" style="font-size: 16px;">点击上传头像&nbsp;&nbsp;<i class="fa fa-chevron-right" id="ix" style="float: none;right:6px;font-size: 16px;position: static;"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <script id="content" name="content" type="text/plain"
                                        style="width: 100%; height: 260px;">${scholar.content!}</script>
	...
	$('#update_scholar_form').ajaxForm({
			...
			success : function(data) {
				if (data.result) {
					...
					showErrors($('#update_scholar_form'),data.errors);
				}
			}
		});
