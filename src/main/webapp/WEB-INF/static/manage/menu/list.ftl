			...
			<div class="col-lg-5">
				<section class="panel">
                          ...
                          <div class="panel-body">
                              <form id="addFolder_form" method="post" class="form-horizontal" autocomplete="off" action="${BASE_PATH}/manage/menu/add.json">
                              	<fieldset>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-xs-9">
	                                      <input style="font-size:15px;width: 200px;"  class="form-control" name="url" placeholder="url">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-xs-3 control-label">父级菜单</label>
                                      <div class="col-xs-9">
				 	<select class="form-control input-lg m-bot15" style="font-size:15px;width: 200px;" name="pid">
									...
									<tbody role="alert" aria-live="polite" aria-relevant="all">
										...
										<tr class="gradeA_firstFolder">
											<td class="folderSort"><input type="text"
												folderId="${folder.id}" value="${folder.sort}" name="sort"
											...
											<td>
												...
												|
												<a class="js_folder_delete" folderId="${folder.id}" pid="${Menu.pid}" href="javascript:void(0);" title="删除">
													删除
												</a>
											</td>
										</tr>
...
$(function() {
    ...
    $(".js_folder_status").change(function(){
		$.post("${BASE_PATH}/manage/menu/status.json", {"id": $(this).attr("folderId"),status:$(this).val()},function(){
