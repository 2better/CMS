		...
		<form class="form-signin" id="adminForm"
			...
			<div class="login-wrap">
				<div class="form-group">
                                      ...
                                      <input type="text" name="name" class="form-control" placeholder="用户名" value="shishuocms" style="*width: 250px;" autofocus>
                                  </div>
 				<div class="form-group">
                                      <label for="exampleInputEmail1">密码</label>
                                      <input type="password" name="password" class="form-control" placeholder="密码" value="shishuocms" style="*width: 250px;">
                                  </div>	                                 	
				<div class="form-group">
					<input type="text" name="captcha" class="form-control" value="12345"
