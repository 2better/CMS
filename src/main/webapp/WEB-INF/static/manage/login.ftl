			...
			<div class="login-wrap">
				<div class="form-group">
 				...
 				<div class="form-group">
                                      ...
                                      <input type="password" required id="password" name="password" class="form-control" placeholder="密码" value="" style="*width: 250px;">
                                  </div>	                                 	
				<div class="form-group">
					<input type="text" name="captcha" class="form-control"  required
						placeholder="验证码" style="width: 120px; float: left;" id="captcha" value=""> <img
